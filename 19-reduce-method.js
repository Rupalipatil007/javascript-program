...
let arrayEmployee =[emp_anil, emp_radha, emp_rishi, emp_sonali]//Find the average salary of employee from company Wipro.
    ...
    console.log(`Average salary is: ${averageSalary}`); emp_viny, emp_mahi;
